...
export const getAllJobs = asyncHandler(
	async (req: Request, res: Response, _next: NextFunction) => {
		...
		res.status(HTTP_STATUS.OK).json(
			new ApiResponse(HTTP_STATUS.OK, "Jobs retrieved", result),
		);
	},
);
...
export const searchJobs = asyncHandler(
	async (req: Request, res: Response, _next: NextFunction) => {
		...
		res.status(HTTP_STATUS.OK).json(
			new ApiResponse(HTTP_STATUS.OK, "Search results", result),
		);
	},
);
...
export const getMyJobs = asyncHandler(
	async (req: AuthRequest, res: Response, _next: NextFunction) => {
		...
		res.status(HTTP_STATUS.OK).json(
			new ApiResponse(HTTP_STATUS.OK, "Your jobs retrieved", result),
		);
	},
);
...
export const getJobById = asyncHandler(
	async (req: Request, res: Response, _next: NextFunction) => {
		...
		res.status(HTTP_STATUS.OK).json(
			new ApiResponse(HTTP_STATUS.OK, "Job retrieved", { job }),
		);
	},
);
...
export const updateJob = asyncHandler(
	async (req: AuthRequest, res: Response, _next: NextFunction) => {
		...
		res.status(HTTP_STATUS.OK).json(
			new ApiResponse(HTTP_STATUS.OK, "Job updated successfully", {
				job,
			}),
		);
	},
...
export const deleteJob = asyncHandler(
	async (req: AuthRequest, res: Response, _next: NextFunction) => {
		...
		res.status(HTTP_STATUS.OK).json(
			new ApiResponse(HTTP_STATUS.OK, "Job deleted successfully", null),
		);
	},
);
