...
export function ContractsPage() {
	...
	// Review state
	const [reviewContract, setReviewContract] = useState<IContract | null>(
		null,
	);
	...
	const StarRating = ({
		...
		<div
			style={{ display: "flex", gap: 4, cursor: "pointer", fontSize: 28 }}
		>
			{[1, 2, 3, 4, 5].map(star => (
				<span
					key={star}
									...
									{contract.status === "active" && (
										<>
											...
											<Button
												...
												onClick={() =>
													navigate(
														`/dashboard/contracts/${contract._id}/chat`,
													)
												}
											>
												💬 Chat
