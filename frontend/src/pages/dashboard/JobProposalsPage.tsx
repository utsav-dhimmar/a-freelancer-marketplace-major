...
export function JobProposalsPage() {
        ...
        return (
            <div className="container py-5 text-center">
                ...
                <Link to="/dashboard/jobs">
                    <Button variant="primary" className="mt-3">Back to My Jobs</Button>
                </Link>
            </div>
        );
    }
    ...
    return (
        <div className="container py-4">
            <Link to="/dashboard/jobs" className="text-decoration-none mb-4 d-inline-block">
                                ...
                                <div className="row">
                                    <div className="col-md-8">
                                        <div className="d-flex justify-content-between align-items-center mb-3">
                                            ...
                                            <span className={`badge bg-${getStatusBadgeVariant(proposal.status)}`}>
                                    ...
                                    <div className="col-md-4 d-flex flex-column justify-content-center border-start">
                                        {proposal.status === 'pending' ? (
                                            <div className="d-grid gap-2 p-3">
                                                ...
                                                >
                                                    {actionLoading === proposal._id ? 'Processing...' : 'Accept Proposal'}
                                                </Button>
                                                <Button
