                        ...
                        <div key={job._id} className="col-md-6 mb-4">
                            <Card className="h-100 d-flex flex-column">
                                <div className="d-flex justify-content-between align-items-start mb-3">
                                    <h4 className="card-title h5 mb-0 text-truncate" style={{ maxWidth: '70%' }}>
                                        {job.title}
                                    </h4>
                                ...
                                <div className="mt-3 pt-3 border-top">
                                    <div className="row text-center mb-3 g-2">
                                        <div className="col-6 border-end">
                                            <div className="text-muted small text-uppercase">Budget</div>
                                        ...
                                        <div className="col-6">
                                            <div className="text-muted small text-uppercase">Deadline</div>
                                    ...
                                    <div className="d-flex gap-2">
                                        ...
                                        <Link to={`/dashboard/jobs/${job._id}/proposals`} className="flex-grow-1">
