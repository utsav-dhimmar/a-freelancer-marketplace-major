		...
		<div className="container py-5">
			...
			<div className="row g-4">
							...
							<div className="d-flex flex-column flex-md-row justify-content-between align-items-start gap-3">
								<div>
									...
									<div className="text-muted small">
										...
										{new Date(
											job.deadline,
										).toLocaleDateString() || job.deadline}
									</div>
								</div>
					...
					<div className="card border-0 shadow-sm">
						<div className="card-body">
							...
							<p className="text-muted mb-0">
								Work closely with the client to deliver a
								high-quality experience. Provide regular updates
								and blur to the team.
							</p>
						</div>
					</div>
				</div>
				...
				<div className="col-lg-4">
					...
					{isAuthenticated && isClient && (
						<div className="card border-0 shadow-sm mb-4">
							<div className="card-body d-grid">
								<Link
									to={`/dashboard/jobs/${id}/proposals`}
					...
					{isAuthenticated && !isClient && user?.role !== 'client' && isOpen && !proposal && (
						<div className="card border-0 shadow-sm mb-4">
							<div className="card-body">
								{!showProposalForm ? (
									<div className="d-grid gap-3">
										...
										<p className="text-muted small mb-0">
											Submit your best proposal to stand
											out.
										</p>
									</div>
								) : (
